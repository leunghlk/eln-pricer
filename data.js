...
const UNIVERSE = [
  ...
  ["HSTECH","3033.HK","Hang Seng Tech Index 恒生科技指数"],
  // ── 2026-08-09: sync full quant-dashboard watchlist into eln-pricer ──
  // US additions
  ["BE","BE","Bloom Energy"],
  ["GLW","GLW","Corning 康寧"],
  ["WDAY","WDAY","Workday"],
  ...
  ["ADBE","ADBE","Adobe"],
  ["NOW","NOW","ServiceNow"],
  ["DLLL","DLLL","Defiance 2X Long DELL ETF"],
  ["PANW","PANW","Palo Alto Networks"],
  ["MSFT","MSFT","Microsoft 微軟"],
  ["AMZN","AMZN","Amazon 亞馬遜"],
  ["GOOG","GOOG","Alphabet 谷歌"],
  ["MAGS","MAGS","Roundhill Magnificent Seven ETF"],
  ["ALAB","ALAB","Astera Labs"],
  ["TER","TER","Teradyne"],
  ["ASML","ASML","ASML Holding 艾司摩爾"],
  ["NET","NET","Cloudflare"],
  ["GEV","GEV","GE Vernova"],
  ["VRT","VRT","Vertiv 維諦"],
  ["AVGO","AVGO","Broadcom 博通"],
  ["SPCX","SPCX","SpaceX 太空探索"],
  ["SKHY","SKHY","SK hynix ADR 海力士"],
  ["HPE","HPE","Hewlett Packard Enterprise 慧與"],
  ...
  ["ON","ON","ON Semiconductor 安森美"],
  ["GFS","GFS","GlobalFoundries 格芯"],
  ["SNOW","SNOW","Snowflake"],
  ["PWR","PWR","Quanta Services"],
  ["CAT","CAT","Caterpillar 卡特彼勒"],
  ["NBIS","NBIS","Nebius Group"],
  ["RDW","RDW","Redwire"],
  ["RKLB","RKLB","Rocket Lab"],
  ["LUNR","LUNR","Intuitive Machines"],
  ["WDC","WDC","Western Digital 西部數據"],
  ["STX","STX","Seagate Technology 希捷"],
  // HK additions
  ["3750","3750.HK","CATL 寧德時代"],
  ["941","0941.HK","China Mobile 中國移動"],
  ["939","0939.HK","CCB 建設銀行"],
  ["1398","1398.HK","ICBC 工商銀行"],
  ["2628","2628.HK","China Life 中國人壽"],
  ["2318","2318.HK","Ping An 中國平安"],
  ["2382","2382.HK","Sunny Optical 舜宇光學"],
  ["9660","9660.HK","Horizon Robotics 地平線機器人"],
  ["883","0883.HK","CNOOC 中國海洋石油"],
  ["3986","3986.HK","GigaDevice 兆易創新"],
  ["1888","1888.HK","Kingboard Laminates 建滔積層板"],
  ["2476","2476.HK","Sheng Hong 勝宏科技"],
  ["2513","2513.HK","Z.AI"],
  ["100","0100.HK","MiniMax"]
];
